...
*/	   // check_p($tblName);
    ...
    {   
        ...
        if($field=='Orderpalletdetail2Name' || $field=='Orderpalletdetail2Qty' || $field=="Orderpalletdetail2Rate" || $field=="Orderpalletdetail2Total" || $field=="Orderpalletdetail2Id")
        {
        ...
        if((stripos($field,'PrintBill')!==false)||(stripos($field,'Print')!==false))  //blank
        {
          ...
          //samundar add field for productprocessid type='hidden' 04-06-2021
        //  else if((strpos($field,'ProductprocessId')!==false))
        // {
        ...
        //samundar add for company name with datalist 22-03-2021
        else if((strpos($field,'CompanyId')!==false))
        {
           // echo $field;
               ...
               // check_p($field);
                ...
                {
                    $strfirst='<div name="'.$field.'div" id="'.$field.'div"   class="col-md-'.$class.' form-group"><label class="col-md-12" >'.label($fieldName).'</label>'; 
                  ...
                  //$strSecond='<input list="browsers"    name="'.$field.$UniqueId.'" id="'.$field.$UniqueId.'" ><datalist id="browsers">';
                        ...
                        {       $flag=0;
                                ...
                                //else
                                {
                                    ...
                                    $strmid=$strmid.'<option data-id="'.$AllDataFieldkey->$field.'"  value="'.$AllDataFieldkey->$field.'-'.$AllDataFieldkey->$fieldName.'" '.((strcmp($AllDataFieldkey->$field,$value)==0)?$selected:'').'></option>';
                        ...
                        else
                        {
                                ...
                                //new removed required for vedor id entry
                                $strSecond='<input type="text" class=" form-control col-md-12 "  list="'.$field.$UniqueId.$datalist.'"   name="'.$field.$UniqueId.'" id="'.$field.$UniqueId.'" value="'.$strSecondValue.'"  ><datalist id="'.$field.$UniqueId.$datalist.'" >';    
        ...
        //samundar end
        else if((strpos($field,'OrderpalletdetailTotal')!==false))
        {
             $str='<input type="hidden" class="form-control  col-md-'.$class.'" name='.$field.$UniqueId.'  value="'.$value.'" id='.$field.$UniqueId.' >';
        }
        else if((strpos($field,'Orderpalletdetail2Total')!==false))
        {
             $str='<input type="hidden" class="form-control  col-md-'.$class.'" name='.$field.$UniqueId.'  value="'.$value.'" id='.$field.$UniqueId.' >';
        }
        else if((strpos($field,'OrderdetailId')!==false)||(strpos($field,'OrderpalletdetailId')!==false)||(strpos($field,'Orderpalletdetail2Id')!==false))
        {
             $str='<input type="hidden" class="form-control  col-md-'.$class.'" name='.$field.$UniqueId.'  value="'.$value.'" id='.$field.$UniqueId.' >';
        }
      
        //samundar add for product name with datalist 05-04-2021
         else if((strpos($field,'ProductId')!==false))
        {
           // echo $field;
                ...
                else
                {
                  ...
                  //$strSecond='<input list="browsers"    name="'.$field.$UniqueId.'" id="'.$field.$UniqueId.'" ><datalist id="browsers">';
                        ...
                        {       $flag=0;
                                ...
                                {
                                    //$strmid=$strmid.'<option data-id="'.$UniqueId.'" value="'.$AllDataFieldkey->$field.'" '.((strcmp($AllDataFieldkey->$field,$value)==0)?$selected:'').'>'.$AllDataFieldkey->$fieldName.'</option>';
                                    $strmid=$strmid.'<option data-id="'.$AllDataFieldkey->$field.'"  value="'.$AllDataFieldkey->$field.'-'.$AllDataFieldkey->$fieldName.'" '.((strcmp($AllDataFieldkey->$field,$value)==0)?$selected:'').'>'.$AllDataFieldkey->$fieldName.'</option>';
                                   /* if(strpos($field,"JobCard")!=false)
                                        $strmid=$strmid.'<option data-id="'.$AllDataFieldkey->$field.'"  value="'.$AllDataFieldkey->$field.'-'.$AllDataFieldkey->$fieldName.'asd" '.((strcmp($AllDataFieldkey->$field,$value)==0)?$selected:'').'></option>';*/
                                    //else
                                       // $strmid=$strmid.'<option data-id="'.$AllDataFieldkey->$field.'"  value="'.$AllDataFieldkey->$field.'-'.$AllDataFieldkey->$fieldName.'"$field '.((strcmp($AllDataFieldkey->$field,$value)==0)?$selected:'').'></option>';
                        ...
                        else
                        {
                                ...
                                //new removed required for vedor id entry
                                /*$strSecond='<input type="text" class=" form-control col-md-12 "  list="'.$field.$UniqueId.$datalist.'"   name="'.$field.$UniqueId.'" id="'.$field.$UniqueId.'" value="'.$strSecondValue.'"  ><datalist id="'.$field.$UniqueId.$datalist.'" >';    */
                                $strSecond='<select class=" form-control col-md-12 " id="'.$field.$UniqueId.'" name="'.$field.$UniqueId.'" >';
                        }
                        $str=$strfirst.$strSecond.$strmid.$strlast;
                   // check_p($str);
        ...
        //nilesh email validation 13/2/2021
        else if((strpos($field,'EmailId')!==false))
        {
            if($tagName=="td")
            {
               // echo  "td k andar".$tagName;
                ...
                $str='<td class="table-width"><input type="Email" class="form-control col-md-12" name="'.$field.$UniqueId.'"  placeholder ="'.$field.'" id="'.$field.$UniqueId.'"  value="'.$value.'" '.$readonlyValue.'></td>';
            ...
            else
            {
                ...
                //code for Devi Motors
                    ...
                    <input type="Email" class="form-control  col-md-12" name="'.$field.'" placeholder ="Enter '.$field.'" id="'.$field.'"  value="'.$value.'"></div>';
            
            }
                
        }
        //nilesh phoneno validation 13/2//2021
        // else if((strpos($field,'PhoneNo')!==false))
        // {
        //     if($tagName=="td")
        //     {
        //       // echo  "td k andar".$tagName;
        ...
        //         //$str='<td><input type="text" class="form-control col-md-12" name="'.$field.$UniqueId.'"  placeholder ="'.$field.'" id="'.$field.$UniqueId.'"  value="'.$value.'" "'.check_exact_field($field,$disableField)?$disableValue:"".'"></td>';
        //         $str='<td class="table-width"><input type="text" class="form-control col-md-12" name="'.$field.$UniqueId.'" pattern="[0-9]{10}" placeholder ="'.$field.'" id="'.$field.$UniqueId.'"  value="'.$value.'" '.$readonlyValue.'  ></td>';
        ...
        //         //code for Devi Motors
        //             $str='<div class=" form-group col-md-'.$class.'" name="'.$field.'"  id="'.$field."div".'" ><label class=" col-md-12"  >'.label($field).'</label>'.' 
        //             <input type="text" class="form-control col-md-12" title="Enter Valid PhoneNo" name="'.$field.'" pattern="[0-9]{10}" placeholder ="Enter '.$field.'" id="'.$field.'"  value="'.$value.'" required></div>';
        ...
        //samundar add for validation(medicallisenceNo, GSTNo) 26-02-2021
        else if((strpos($field,'DrugLisenceNo')!==false))
        {
            if($tagName=="td")
            {
               // echo  "td k andar".$tagName;
            ...
            {
                    $str='<div class=" form-group col-md-'.$class.'" name="'.$field.'"  id="'.$field."div".'" ><label class=" col-md-12"  >'.label($field).'</label>'.' 
                    <input type="text" class="form-control col-md-12"  name="'.$field.'"  placeholder ="Enter '.$field.'" id="'.$field.'"  value="'.$value.'" required></div>';
            
            }
                
        }
        // else if((strpos($field,'GSTNo')!==false))
        // {
        //     if($tagName=="td")
        //     {
        //       // echo  "td k andar".$tagName;
        ...
        // }
        // else if((strpos($field,'PANNo')!==false))
        // {
        //     if($tagName=="td")
        //     {
        //       // echo  "td k andar".$tagName;
        ...
        //samundar add for a/c type in transport expert 03-07-2021
         else if((stripos($field,'CompanyType')!==false))
        {   
            if($tagName=="td")
            {
                $strfirst='<td class="table-width">';
            ...
            $strSecond='<select class="form-control col-md-12" name="'.$field.$UniqueId.'" id="'.$field.$UniqueId.'">';
                        ...
                        $strmid="";
                        //check_p($AllTableName);
                        $data=array("CurrentAccount","SavingsAccount ","Other");
                        foreach($data as $AllDataFieldkey)
                        {       
                            $strmid=$strmid.'<option value="'.ucfirst(remove('tbl',$AllDataFieldkey)).'">'.ucfirst(remove('tbl',$AllDataFieldkey)).'</option>';
                        }
        ...
        else if((stripos($field,'RateDropDown')!==false))
        {   
            if($tagName=="td")
            {
                $strfirst='<td class="table-width">';
        ...
        {   
            ...
            $strSecond='<select class="form-control col-md-12" name="'.$field.$UniqueId.'" id="'.$field.$UniqueId.'">';
                        ...
                        $selected="selected";
                        //check_p($AllTableName);
                        $strmid=$strmid.'<option value="Receipt">Receipt</option><option value="Payment">Payment</option><option value="Opening">opening</option>';
                        $str=$strfirst.$strSecond.$strmid.$strlast;
        }
        //nilesh ledger Type 13/2/2021
        else if((stripos($field,'LedgerType')!==false))
        {   
            if($tagName=="td")
            {
                $strfirst='<td class="table-width">';
            ...
            $strSecond='<select class="form-control col-md-12" name="'.$field.$UniqueId.'" id="'.$field.$UniqueId.'">';
                        ...
                        $selected="selected";
                        //check_p($AllTableName);
                        $strmid=$strmid.'<option value="Registered">Registered</option><option value="Unregistered">Unregistered</option><option value="Related">Related</option><option value="Prohibited">Prohibited</option>';
                        $str=$strfirst.$strSecond.$strmid.$strlast;
        }
        else if((stripos($field,'OrderStageDropDown')!==false))
        {   
            if($tagName=="td")
            {
                $strfirst='<td class="table-width">';
            ...
            $strSecond='<select class="form-control col-md-12" name="'.$field.$UniqueId.'" id="'.$field.$UniqueId.'">';
                        ...
                        $selected="selected";
                        //check_p($AllTableName);
                        $strmid=$strmid.'<option value="Processing">Processing</option><option value="Packed">Packed</option><option value="Dispatched">Dispatched</option><option value="Delivered">Delivered</option><option value="other">other</option><option value="Cancel">Cancel</option>';
                        $str=$strfirst.$strSecond.$strmid.$strlast;
        }
        //nilesh producttype item dropdown
        else if((stripos($field,'ProductType')!==false))
        {   
            if($tagName=="td")
            {
                $strfirst='<td class="table-width">';
            ...
            $strSecond='<select class="form-control col-md-12" name="'.$field.$UniqueId.'" id="'.$field.$UniqueId.'">';
                        ...
                        $selected="selected";
                        //check_p($AllTableName);
                        $strmid=$strmid.'<option value="Normal">Normal</option><option value="Prohibited">Prohibited</option>';
                        $str=$strfirst.$strSecond.$strmid.$strlast;
        }
        //nilesh productitemtype dropdown
        //samundar add 11-03-2021
        else if((stripos($field,'OrderPaymentStatus')!==false))
        {   
            if($tagName=="td")
            {
                $strfirst='<td class="table-width">';
            ...
            $strSecond='<select class="form-control col-md-12" name="'.$field.$UniqueId.'" id="'.$field.$UniqueId.'">';
                        ...
                        $selected="selected";
                        //check_p($AllTableName);
                        $strmid=$strmid.'<option value="Pending">Pending</option>
                        <option value="parcial">Parcial</option>
                        <option value="Done">Done</option>';
                        $str=$strfirst.$strSecond.$strmid.$strlast;
        }
        else if((stripos($field,'OrderPaymentVerify')!==false))
        {   
            if($tagName=="td")
            {
                $strfirst='<td class="table-width">';
            ...
            $strSecond='<select class="form-control col-md-12" name="'.$field.$UniqueId.'" id="'.$field.$UniqueId.'">';
                        ...
                        $selected="selected";
                        //check_p($AllTableName);
                        $strmid=$strmid.'<option value="Pending" selected>Pending</option>
                        <option value="Done">Done</option>';
                        $str=$strfirst.$strSecond.$strmid.$strlast;
        }
        //samundar end
         else if((stripos($field,'ProductItemType')!==false))
        {   
            if($tagName=="td")
            {
                $strfirst='<td class="table-width">';
            ...
            $strSecond='<select class="form-control col-md-12" name="'.$field.$UniqueId.'" id="'.$field.$UniqueId.'">';
                        ...
                        $selected="selected";
                        //check_p($AllTableName);
                        $strmid=$strmid.'<option value="Normal">Normal</option><option value="Costlyitem">Costlyitem</option><option value="8&#176;Storage">8&#176;Storage</option><option value="24&#176;Storage">24&#176;Storage</option>';
                        $str=$strfirst.$strSecond.$strmid.$strlast;
        }
        //nilesh product Local-central dropdown
         else if((stripos($field,'ProductLocal_central')!==false))
        {   
            if($tagName=="td")
            {
                $strfirst='<td class="table-width">';
            ...
            $strSecond='<select class="form-control col-md-12" name="'.$field.$UniqueId.'" id="'.$field.$UniqueId.'">';
                        ...
                        $selected="selected";
                        //check_p($AllTableName);
                        $strmid=$strmid.'<option value="Taxable">Taxable</option><option value="Tax Paid">Tax Paid</option><option value="Exempted">Exempted</option>';
                        $str=$strfirst.$strSecond.$strmid.$strlast;
        }
          //nilesh product vender type dropdown
         else if((stripos($field,'VendorType')!==false))
        {   
            if($tagName=="td")
            {
                $strfirst='<td class="table-width">';
            ...
            $strSecond='<select class="form-control col-md-12" name="'.$field.$UniqueId.'" id="'.$field.$UniqueId.'">';
                        ...
                        $selected="selected";
                        //check_p($AllTableName);
                        $strmid=$strmid.'<option value="Stockist">Stockist</option><option value="Distributor">Distributor</option><option value="Other">Other</option>';
                        $str=$strfirst.$strSecond.$strmid.$strlast;
        }
        //nilesh packing veration dropdown
       /* else if((stripos($field,'Packing')!==false))
        {   
            if($tagName=="td")
            {
                $strfirst='<td class="table-width">';
            ...
            $strSecond='<select class="form-control col-md-12" name="'.$field.$UniqueId.'" id="'.$field.$UniqueId.'">';
                        ...
                        $selected="selected";
                        //check_p($AllTableName);
                        $strmid=$strmid.'<option value="10 Tab In 1 Strip">10 Tab In 1 Strip</option><option value="15 Tab In 1 Strip">15 Tab In 1 Strip</option><option value="7 Tab In 1 Strip">7 Tab In 1 Strip</option><option value="60Ml  In 1 bottel">60Ml  In 1 bottel</option><option value="100Ml  In 1 bottel">100Ml  In 1 bottel</option><option value="170Ml  In 1 bottel">170Ml  In 1 bottel</option><option value="200Ml  In 1 bottel">200Ml  In 1 bottel</option>';
                        $str=$strfirst.$strSecond.$strmid.$strlast;
        }*/
        //end
        ...
        else if((stripos($field,'Image')!==false)||(stripos($field,'PDF')!==false)||(stripos($field,'Document')!==false)||(stripos($field,'Proof')!==false)||(stripos($field,'Logo')!==false))
        {
            ...
            {
            $str='<div class="col-md-'.$class.'   form-group" id="'.$field."div".'" name="'.$field."div".'"><label class="col-md-12" >'.label($field).'</label>'.' 
        ...
        {   //input type else
            if($tagName=="td")
            {
               // echo  "td k andar".$tagName;
                ...
                //$str='<td><input type="text" class="form-control col-md-12" name="'.$field.$UniqueId.'"  placeholder ="'.$field.'" id="'.$field.$UniqueId.'"  value="'.$value.'" "'.check_exact_field($field,$disableField)?$disableValue:"".'"></td>';
                $str='<td class="table-width"><input type="text" class="form-control '.$field.' col-md-12" name="'.$field.$UniqueId.'"  placeholder ="'.$field.'" id="'.$field.$UniqueId.'"  value="'.$value.'" '.$readonlyValue.'></td>';
            ...
            else
            {
                ...
                //code for Devi Motors
                    $str='<div class=" form-group col-md-'.$class.'" name="'.$field.'" id="'.$field."div".'" ><label class=" col-md-12"  >'.label($field).'</label>'.' 
                    <input type="text" class="form-control col-md-12 '.$field.'" name="'.$field.'"  placeholder ="Enter '.$field.'" id="'.$field.'"  value="'.$value.'"></div>';
    ...
    function ajax_success_data_with_key_old($arrayData,$key='',$uniqueId='')
    {   $str="";
        //    update for new frame work to multiple search 14/4/2019
            //  $arrayData=remove_last_field($arrayData,4);
