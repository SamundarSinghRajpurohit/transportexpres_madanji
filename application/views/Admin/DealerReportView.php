          ...
          <div class="col-md-6">
            <div class="card ">
              <div class="card-header admin-custom-color-g">
                <h3 class="card-title">Dealer Rerport From</h3>
              </div>
              <form name="DealerReport" method="POST" action="<?=base_url('/Admin/DealerReportDifferent')?>"autocomplete="off">
                <div class="card-body">

                    <!-- sjr add gst invoice invoice number 28-12-2023 -->
                    <div class="form-group">
                      <label>Invoice No/Gst Invoice No.</label>
    
                      <div class="input-group">
                        <div class="input-group ">
                            <input type="text" class="form-control" autocomplete="false" name="InvoiceNo"  id="InvoiceNo" required>
