    ...
    <ul class="navbar-nav ml-auto">
      <li class="nav-item dropdown">
        <a class="nav-link" data-toggle="dropdown" href="#" style="cursor: pointer;">
          ...
          <label><?=$this->session->Username;?></label>
        </a>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="<?=$baseUrl?>dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Complaint Forum</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <span style="height:30px;width:30px;background: #eee;color:black;display: block;border-radius: 50%;text-align: center;font-size: 20px;line-height: 45px;"><i class="fa fa-user"></i></span>
        </div>
        <div class="info">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?=site_url('employee_c');?>" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?=site_url('user_c');?>" class="nav-link">
              <i class="nav-icon fa fa-th"></i>
              <p>
                Users
              </p>
          ...
          <li class="nav-item">
            <a href="<?=site_url('product_c');?>" class="nav-link">
              <i class="nav-icon fa fa-th"></i>
              <p>
                Products
              </p>
          ...
          <li class="nav-item">
            <a href="<?=site_url('complaint_c');?>" class="nav-link">
              <i class="nav-icon fa fa-th"></i>
              <p>
                Complaints
              </p>
          ...
          <div class="col-12">
            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row no-print">
                <div class="col-12">
                  <a href="<?=site_url('complaint_c/get_print/');?>" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Print</a>
