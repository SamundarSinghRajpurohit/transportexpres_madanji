          ...
          <div class="col-md-6">
            <div class="card ">
              <div class="card-header admin-custom-color-g">
                <h3 class="card-title">Tempo Rerport From</h3>
              </div>
              <form name="DealerReport" method="POST" action="<?=base_url('/Admin/TempoReportDifferent')?>"autocomplete="off">
                <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control box all" name="TempoAll" id="TempoAll" Value="All" readonly>
                      <div class="input-group">
                        <div class="input-group ">
                            <input type="text" class="form-control datalist tempolist box single" autocomplete="false" list="tempolist" name="TempoId"  id="TempoId">
