            ...
            <div class="modal-body">
                <form id="AddUpdateForm" name="AddUpdateForm" enctype="multipart/form-data">
                  <div class="card-body">  
                        ...
                        <!--<div class="col-md-6 form-group"><label class="col-md-12"> Firm Name</label><input type="text" class=" form-control col-md-12 " list="FirmIddatalist" name="FirmId" id="FirmId" value="" required=""><datalist id="FirmIddatalist"></datalist></div>-->         
                        <div class="col-md-6 form-group"><label class="col-md-12"> Accounts Name</label><input type="text" class=" form-control col-md-12 " list="AccountsIddatalist" name="AccountsId" id="AccountsId" value="" required=""><datalist id="AccountsIddatalist"></datalist></div>
                        <div class=" form-group col-md-6"><label class=" col-md-12" id="LabelPurchaseDate">  Date</label> 
                        <input type="date" class="form-control col-md-12" name="PurchaseDate" placeholder="Enter PurchaseDate" id="PurchaseDate" value=""></div>                                                                                
                        <div class=" form-group col-md-6" name="PurchaseOrderno" id="PurchaseOrdernodiv"><label class=" col-md-12"> Purchase Orderno</label> 
                        <input type="text" class="form-control col-md-12" name="PurchaseOrderno" placeholder="Enter PurchaseOrderno" id="PurchaseOrderno" value=""></div>                                                                                
                        <div class=" form-group col-md-6" name="PurchaseDiscount" id="PurchaseDiscountdiv"><label class=" col-md-12"> Purchase Discount</label> 
                        <input type="text" class="form-control col-md-12" name="PurchaseDiscount" placeholder="Enter PurchaseDiscount" id="PurchaseDiscount" value=""></div>                                                                                
                        <div class=" form-group col-md-6" name="PurchaseTotal" id="PurchaseTotaldiv"><label class=" col-md-12"> Purchase Total</label> 
                        <input type="text" class="form-control col-md-12" name="PurchaseTotal" placeholder="Enter PurchaseTotal" id="PurchaseTotal" value=""></div>                                                                                    
