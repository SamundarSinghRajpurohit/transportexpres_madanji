                        ...
                        <div class="col-md-8">
                            <div class="card custom-card">
                                ...
                                <tr class="custom-table-tr">
                                  ...
                                  <th class="custom-table-th">Question</th>
                                  <th class="custom-table-th">Answer</th>
                                ...
                                {   ?>
                                        <tr class="custom-table-tr">
                                            ...
                                            <td class="custom-table-td"><?=$mainData[$i]["FaqQuestion"]?></td>
                                            <td class="custom-table-td"><?=$mainData[$i]["FaqAnswer"]?></td>
                                            <td class="custom-table-td"><a id="<?=$mainData[$i]["FaqId"]?>" class="updatedata" data-toggle="modal" data-target="#insert-modal" ><i class="fa fa-edit admin-custom-color-opp" ></i></a><a id="<?=$mainData[$i]["FaqId"]?>" class="deletedata"><i class="fa fa-trash admin-custom-color-opp" ></i></a></td>
                                        </tr> 
                                   <?php 
                                }
                                ?>
