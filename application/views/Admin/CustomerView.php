<div class="content-wrapper" style="min-height: 496px;" onload="removeElement()">
                            ...
                            <div class="card custom-card">
                                ...
                                {   ?>
                                        <tr class="custom-table-tr">
                                            ...
                                            <td class="custom-table-td"><?=$mainData[$i]["CustomerName"]?></td>
                                            <td class="custom-table-td"><?=$mainData[$i]["CustomerEmailId"]?></td>
                                            <td class="custom-table-td"><?=$mainData[$i]["CustomerPhoneNo"]?></td>
                                            <td class="custom-table-td"><?=$mainData[$i]["CustomerCompanyName"]?></td>
                                            <td class="custom-table-td"><?=$mainData[$i]["CustomerGSTNo"]?></td>
                                            <td class="custom-table-td-img"><img src="<?=base_url('/resources/images/'.$mainData[$i]["CustomerImage"])?>" style="height:100px; width:100px;"></td>
                                            <td class="custom-table-td">
                                                <a id="<?=$mainData[$i]["CustomerId"]?>" class="updatedata" data-toggle="modal" data-target="#insert-modal" >
                                                <i class="fa fa-edit admin-custom-color-opp" ></i></a>
                                            <a id="<?=$mainData[$i]["CustomerId"]?>" class="deletedata"><i class="fa fa-trash admin-custom-color-opp" ></i></a></td>
                                        </tr> 
                                   <?php 
                                }
                                ?>
...
{
     var x = document.getElementById("CustomerFCMTokendiv");
