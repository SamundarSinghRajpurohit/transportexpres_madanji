($i+1)<div class="content-wrapper" style="min-height: 496px;">
                        ...
                        <div class="col-md-8">
                            <div class="card custom-card">
                                ...
                                <tr class="custom-table-tr">
                                  ...
                                  <th class="custom-table-th">EmailId</th>
                                ...
                                {   ?>
                                        <tr class="custom-table-tr">
                                            ...
                                            <td class="custom-table-td"><?=$mainData[$i]["ManufacturerName"]?></td>
                                            <td class="custom-table-td"><?=$mainData[$i]["ManufacturerEmailId"]?></td>
                                            <td class="custom-table-td"><?=$mainData[$i]["ManufacturerPhoneNo"]?></td>
                                            <td class="custom-table-td"><?=$mainData[$i]["ManufacturerCompanyName"]?></td>
                                            <td class="custom-table-td"><?=$mainData[$i]["ManufacturerAddress"]?></td>
                                            <td class="custom-table-td"><?=$mainData[$i]["ManufacturerGSTNo"]?></td>
                                            <td class="custom-table-td-img"><img src="<?=base_url('/resources/images/'.$mainData[$i]["ManufacturerImage"])?>" style="height:100px; width:100px;"></td>
                                            <td class="custom-table-td"><a id="<?=$mainData[$i]["ManufacturerId"]?>" class="updatedata" data-toggle="modal" data-target="#insert-modal" ><i class="fa fa-edit admin-custom-color-opp" ></i></a><a id="<?=$mainData[$i]["ManufacturerId"]?>" class="deletedata"><i class="fa fa-trash admin-custom-color-opp" ></i></a></td>
                                        </tr> 
                                   <?php 
                                }
                                ?>
