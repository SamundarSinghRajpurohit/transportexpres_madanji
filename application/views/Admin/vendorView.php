                        ...
                        <div class="col-md-12 pt-3">
                            <div class="card custom-card">
                                ...
                                <tr class="custom-table-tr">
                                  ...
                                  <th class="custom-table-th">Vender Type</th>
                                ...
                                {   ?>
                                        <tr class="custom-table-tr">
                                            ...
                                            <td class="custom-table-td"><a id="<?=$mainData[$i]["VendorId"]?>" class="updatedata" data-toggle="modal" data-target="#insert-modal" >
                                                <i class="fa fa-edit admin-custom-color-opp" ></i></a>
                                                <a href="<?=site_url('Admin/VendorViewDifferent/'.$mainData[$i]["VendorId"])?>" ><i class="fa fa-eye admin-custom-color-opp" ></i></a>
                                            <a id="<?=$mainData[$i]["VendorId"]?>" class="deletedata"><i class="fa fa-trash admin-custom-color-opp" ></i></a>
                                            </td>                                            
                                        </tr> 
                                   <?php 
                                }
...
<script>
removeElement("AccountsIddiv");
function removeElement(AccountsId)
{
    var w = document.getElementById(AccountsId);
