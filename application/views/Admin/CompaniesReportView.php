          ...
          <div class="col-md-6">
            <div class="card ">
              <div class="card-header admin-custom-color-g">
                <h3 class="card-title">Companies Rerport From</h3>
              </div>
              <form name="DealerReport" method="POST" action="<?=base_url('/Admin/CompaniesReportDifferent')?>"autocomplete="off">
                <div class="card-body">
                    ...
                    <div class="form-check">
                      <input class="form-check-input type-report" type="radio" name="exampleRadios" id="exampleRadios1" value="single" checked>
                      <label class="form-check-label" for="exampleRadios1">
                        Single
                      </label>
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      <input class="form-check-input type-report" type="radio" name="exampleRadios" id="exampleRadios2" value="all">
                      <label class="form-check-label" for="exampleRadios2">
                        All
                      </label>
                     </div>
                    <div class="form-check pt-3">
                     <input class="form-check-input" type="radio" name="lr" id="lr" value="lr" checked>
                        <label class="form-check-label" for="lr">
                            Lr
                        </label>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <input class="form-check-input" type="radio" name="lr" id="pallet" value="pallet">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control box all" name="CompaniesAll" id="CompaniesAll" Value="All" readonly>
                      <div class="input-group">
                        <div class="input-group ">
                            <input type="text" class="form-control datalist companieslist box single" autocomplete="false" list="companieslist" name="CompaniesId"  id="CompaniesId">
