                        ...
                        <div class="col-md-12 pt-3">
                            <div class="card custom-card">
                                ...
                                <tr class="custom-table-tr">
                                  ...
                                  <th class="custom-table-th">SubCategory</th>
                                  <th class="custom-table-th">Company Name</th>
                                  <th class="custom-table-th">Images</th>
                                  <th class="custom-table-th">Packing</th>
                                  <th class="custom-table-th">Expirydate</th>
                                  <th class="custom-table-th">QTY</th>
                                  <th class="custom-table-th">MRP</th>
                                  <th class="custom-table-th">SRP</th>
                                ...
                                {   ?>
                                        <tr class="custom-table-tr">
                                            ...
                                            <td class="custom-table-td"><?=$mainData[$i]["ProductdetailName"]?></td>
                                            <td class="custom-table-td"><?=$mainData[$i]["SubcategoryName"]?></td>
                                            <td class="custom-table-td"><?=$mainData[$i]["CompanyName"]?></td>
                                            <td class="custom-table-td-img"><img src="<?=base_url('/resources/images/'.$mainData[$i]["ProductdetailImages"])?>" style="height:100px; width:100px;"></td>
                                            <td class="custom-table-td"><?=$mainData[$i]["PackingName"]?></td>
                                            <td class="custom-table-td"><?=$mainData[$i]["ProductdetailExpiryDate"]?></td>
                                            <td class="custom-table-td"><?=$mainData[$i]["ProductdetailQty"]?></td>
                                            <td class="custom-table-td"><?=$mainData[$i]["ProductdetailMRP"]?></td>
                                            <td class="custom-table-td"><?=$mainData[$i]["ProductdetailSRP"]?></td>
                                            <td class="custom-table-td"><a id="<?=$mainData[$i]["ProductdetailId"]?>" class="updatedata" data-toggle="modal" data-target="#insert-modal" >
                                                <i class="fa fa-edit admin-custom-color-opp" ></i></a>
                                            <a id="<?=$mainData[$i]["ProductdetailId"]?>" class="deletedata"><i class="fa fa-trash admin-custom-color-opp" ></i></a>
                                            </td>                                            
                                        </tr> 
                                   <?php 
                                }
