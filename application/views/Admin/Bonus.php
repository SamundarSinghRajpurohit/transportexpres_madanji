                        ...
                        <div class="col-md-12 pt-3">
                            <div class="card custom-card">
                                ...
                                <tr class="custom-table-tr">
                                  ...
                                  <th class="custom-table-th">CustomerID</th>
                                  <th class="custom-table-th">MedicalstoreID</th>
                                  <th class="custom-table-th">OrderID</th>
                                  <th class="custom-table-th">Point</th>
                                  <th class="custom-table-th">BonusType</th>
                                  <th class="custom-table-th">Date</th>
                                ...
                                {   ?>
                                        <tr class="custom-table-tr">
                                            ...
                                            <td class="custom-table-td"><?=$mainData[$i]["CustomerId"]?></td>
                                            <td class="custom-table-td"><?=$mainData[$i]["MedicalstoreId"]?></td>
                                            <td class="custom-table-td"><?=$mainData[$i]["OrderId"]?></td>
                                            <td class="custom-table-td"><?=$mainData[$i]["BonusPoints"]?></td>
                                            <td class="custom-table-td"><?=$mainData[$i]["BonusType"]?></td>
                                            <td class="custom-table-td"><?=$mainData[$i]["BonusDate"]?></td>
                                      
                                            <td class="custom-table-td"><a id="<?=$mainData[$i]["BonusId"]?>" class="updatedata" data-toggle="modal" data-target="#insert-modal" ><i class="fa fa-edit admin-custom-color-opp" ></i></a>
                                                                        <a id="<?=$mainData[$i]["BonusId"]?>" class="deletedata"><i class="fa fa-trash admin-custom-color-opp" ></i></a></td>
                                        </tr> 
                                   <?php 
                                }
                                ?>
