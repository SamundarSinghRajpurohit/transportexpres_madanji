                        ...
                        <div class="col-md-12 pt-3">
                            <div class="card custom-card">
                                ...
                                <tr class="custom-table-tr">
                                  ...
                                  <th class="custom-table-th">Product status</th>
                                  <th class="custom-table-th">Product CDT</th>
                                ...
                                {   ?>
                                        <tr class="custom-table-tr">
                                            ...
                                            <td class="custom-table-td"><?=$mainData[$i]["ProductName"]?></td>
                                            <td class="custom-table-td"><?=$mainData[$i]["CompanyName"]?></td>
                                           
                                            <td class="custom-table-td"><?=$mainData[$i]["ProductStatus"]?></td>
                                            <td class="custom-table-td"><?=$mainData[$i]["ProductCDT"]?></td>
                                           
                                            <td class="custom-table-td"><a id="<?=$mainData[$i]["ProductId"]?>" class="updatedata" data-toggle="modal" data-target="#insert-modal" >
                                                <i class="fa fa-edit admin-custom-color-opp" ></i></a>
                                            <a id="<?=$mainData[$i]["ProductId"]?>" class="deletedata"><i class="fa fa-trash admin-custom-color-opp" ></i></a>
                                            </td>                                            
                                        </tr> 
                                   <?php 
                                }
