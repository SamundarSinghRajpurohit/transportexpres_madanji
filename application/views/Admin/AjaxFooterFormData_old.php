...
$(document).on('blur',".form-control",function(){
    ...
    //call any ajax only if contains id 
     if(((IdName.includes("EmployeeId"))||(IdName.includes("MonthId"))||(IdName.includes("LabourId"))||(IdName.includes("ProductId")))&&(!IdName.includes("EmailId"))&&$(this).val())
    {
        //alert()
...
$(document).on('keyup',".form-control",function(){
 var IdName =$(this).attr("id");
/*    
 if(IdName.includes("MemberdetailName"))
    {
        $(this).val(finalMemberNo);
    }
  */  
