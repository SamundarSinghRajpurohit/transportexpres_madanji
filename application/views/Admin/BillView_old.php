                     ...
                     //   print_r($orderDetail);
                        ...
                        {   ?>
                                <tr>
                                    ...
                                    <td><?=$orderDetail[$i]->OrderdetailBarcodeNo?></td>
                                    <td><?=$orderDetail[$i]->OrderdetailQty?></td>
                                    <td><?=$orderDetail[$i]->OrderdetailProductSrp?></td>
                                    
                                    <td><?=(int)$orderDetail[$i]->OrderdetailQty*(int)$orderDetail[$i]->OrderdetailProductSrp?></td>
                                </tr> 
                           <?php 
                        }
                        ?>
