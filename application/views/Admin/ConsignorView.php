                        ...
                        <div class="col-md-12 pt-3">
                            <div class="card custom-card">
                                ...
                                <tr class="custom-table-tr">
                                  ...
                                  <th class="custom-table-th">Consignor Name</th>
                                  <th class="custom-table-th">Company Name</th>
                                  <th class="custom-table-th">Consignor Address</th>
                                  <th class="custom-table-th">Consignor Email</th>
                                  <th class="custom-table-th">Consignor GstNo</th>
                                  <th class="custom-table-th">Consignor Image</th>
                                  <th class="custom-table-th">Consignor PhoneNo</th>
                                ...
                                {   ?>
                                        <tr class="custom-table-tr">
                                            ...
                                            <td class="custom-table-td"><?=$mainData[$i]["ConsignorName"]?></td>
                                            <td class="custom-table-td"><?=$mainData[$i]["CompanyName"]?></td>
                                            <td class="custom-table-td"><?=$mainData[$i]["ConsignorAddress"]?></td>
                                            <td class="custom-table-td"><?=$mainData[$i]["ConsignorEmailId"]?></td>
                                            <td class="custom-table-td"><?=$mainData[$i]["ConsignorGSTNo"]?></td>
                                            <td class="custom-table-td-img"><img src="<?=base_url('/resources/images/'.$mainData[$i]["ConsignorImage"])?>" style="height:100px; width:100px;"></td>
                                            <td class="custom-table-td"><?=$mainData[$i]["ConsignorPhoneNo"]?></td>
                                            <td class="custom-table-td"><a id="<?=$mainData[$i]["ConsignorId"]?>" class="updatedata" data-toggle="modal" data-target="#insert-modal" >
                                                <i class="fa fa-edit admin-custom-color-opp" ></i></a>
                                            <a id="<?=$mainData[$i]["ConsignorId"]?>" class="deletedata"><i class="fa fa-trash admin-custom-color-opp" ></i></a>
                                            </td>                                            
                                        </tr> 
                                   <?php 
                                }
