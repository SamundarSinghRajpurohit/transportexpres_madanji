                        ...
                        <div class="col-md-8">
                            <div class="card custom-card">
                                ...
                                <tr class="custom-table-tr">
                                  ...
                                  <th class="custom-table-th">Category Name</th>
                                ...
                                {   ?>
                                        <tr class="custom-table-tr">
                                            ...
                                            <td class="custom-table-td"><?=$mainData[$i]["CategoryName"]?></td>
                                              <td class="custom-table-td-img"><img src="<?=base_url('/resources/images/'.$mainData[$i]["SubcategoryImage"])?>" style="height:100px; width:100px;"></td>
                                          
                                            <td class="custom-table-td"><a id="<?=$mainData[$i]["SubcategoryId"]?>" class="updatedata" data-toggle="modal" data-target="#insert-modal" ><i class="fa fa-edit admin-custom-color-opp" ></i></a><a id="<?=$mainData[$i]["SubcategoryId"]?>" class="deletedata"><i class="fa fa-trash admin-custom-color-opp" ></i></a></td>
                                        </tr> 
                                   <?php 
                                }
                                ?>
