                        ...
                        <div class="col-md-8">
                            <div class="card custom-card">
                                ...
                                <tr class="custom-table-tr">
                                  ...
                                  <th class="custom-table-th">Levevl Name</th>
                                ...
                                {   ?>
                                        <tr class="custom-table-tr">
                                            ...
                                            <td class="custom-table-td"><?=$mainData[$i]["AdminName"]?></td>
                                            <td class="custom-table-td"><?=$mainData[$i]["AdminEmailId"]?></td>
                                            <td class="custom-table-td"><?=$mainData[$i]["LevelName"]?></td>
                                            <td class="custom-table-td"><a id="<?=$mainData[$i]["AdminId"]?>" class="updatedata" data-toggle="modal" data-target="#insert-modal" ><i class="fa fa-edit admin-custom-color-opp" ></i></a><a id="<?=$mainData[$i]["AdminId"]?>" class="deletedata"><i class="fa fa-trash admin-custom-color-opp" ></i></a></td>
                                        </tr> 
                                   <?php 
                                }
                                ?>
