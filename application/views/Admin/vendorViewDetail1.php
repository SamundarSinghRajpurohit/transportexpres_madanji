                        ...
                        <div class="col-md-12 pt-3">
                            ...
                            <div class="card custom-card">
                                ...
                                <tr class="custom-table-tr">
                                  ...
                                  <th class="custom-table-th">Vendor Type</th>
                                  <th class="custom-table-th">Bank A/C Type</th>
                                  <th class="custom-table-th">Branch Name</th>
                                  <th class="custom-table-th">Bank Name</th>
                                  <th class="custom-table-th">Bank A/C.No</th>
                                  <th class="custom-table-th">Bank IFSC Code</th>
                                  <th class="custom-table-th">Ledger Type</th>
                                ...
                                {   ?>
                                        <tr class="custom-table-tr">
                                            ...
                                            <td class="custom-table-td"><?=$mainData[$i]["VendorName"]?></td>
                                            <td class="custom-table-td"><?=$mainData[$i]["VendorAddress"]?></td>
                                            <td class="custom-table-td"><?=$mainData[$i]["VendorPhoneNo"]?></td>
                                            <td class="custom-table-td"><?=$mainData[$i]["VendorEmailId"]?></td>
                                            <td class="custom-table-td"><?=$mainData[$i]["VendorPANNo"]?></td>
                                            <td class="custom-table-td"><?=$mainData[$i]["VendorGSTNo"]?></td>
                                            <td class="custom-table-td"><?=$mainData[$i]["VendorType"]?></td>
                                            <td class="custom-table-td"><?=$mainData[$i]["VendorBankAccountType"]?></td>
                                            <td class="custom-table-td"><?=$mainData[$i]["VendorBankName"]?></td>
                                            <td class="custom-table-td"><?=$mainData[$i]["VendorBankAccount"]?></td>
                                            <td class="custom-table-td"><?=$mainData[$i]["VendorBankIFSCCode"]?></td>
                                            <td class="custom-table-td"><?=$mainData[$i]["VendorLedgerType"]?></td>
                                            
                                           <!-- <td class="custom-table-td"><a id="</?=$mainData[$i]["VenderId"]?>" class="updatedata" data-toggle="modal" data-target="#insert-modal" >
                                                <i class="fa fa-edit admin-custom-color-opp" ></i></a>
                                                <a href="</?=site_url('Admin/VenderViewDifferent/'.$mainData[$i]["VenderId"])?>" ><i class="fa fa-eye admin-custom-color-opp" ></i></a>
                                            <a id="</?=$mainData[$i]["VenderId"]?>" class="deletedata"><i class="fa fa-trash admin-custom-color-opp" ></i></a>
                                            </td>-->                                            
                                        </tr> 
                                   <?php 
                                }
