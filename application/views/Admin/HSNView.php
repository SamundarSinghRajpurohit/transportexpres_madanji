                            ...
                            <div class="card custom-card">
                               <table class=" table-bordered   table custom-table m-0" cellspacing="0" id="example2" >
                                ...
                                <tr class="custom-table-tr">
                                  ...
                                  <th class="custom-table-th">TAX</th>
                                ...
                                {   ?>
                                        <tr class="custom-table-tr">
                                            ...
                                            <td class="custom-table-td"><?=$mainData[$i]["HsnName"]?></td>
                                            <td class="custom-table-td"><?=$mainData[$i]["HsnTax"]?></td>
                                            <td class="custom-table-td"><a id="<?=$mainData[$i]["HsnId"]?>" class="updatedata" data-toggle="modal" data-target="#insert-modal" ><i class="fa fa-edit admin-custom-color-opp" ></i></a><a id="<?=$mainData[$i]["HsnId"]?>" class="deletedata"><i class="fa fa-trash admin-custom-color-opp" ></i></a></td>
                                        </tr> 
                                   <?php 
                                }
                                ?>
