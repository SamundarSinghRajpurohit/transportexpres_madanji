                        ...
                        <div class="col-md-12 pt-3">
                            <div class="card custom-card">
                                ...
                                <tr class="custom-table-tr">
                                  ...
                                  <th class="custom-table-th">Consignee Name</th>
                                  <th class="custom-table-th">Company Name</th>
                                  <th class="custom-table-th">Consignee Email</th>
                                  <th class="custom-table-th">Consignee Address</th>
                                  <th class="custom-table-th">Consignee Image</th>
                                  <th class="custom-table-th">Consignee PhoneNo</th>
                                  <th class="custom-table-th">Consignee GstNo</th>
                                  <th class="custom-table-th">Consignee PanNo</th>
                                ...
                                {   ?>
                                        <tr class="custom-table-tr">
                                            ...
                                            <td class="custom-table-td"><?=$mainData[$i]["ConsigneeName"]?></td>
                                            <td class="custom-table-td"><?=$mainData[$i]["CompanyName"]?></td>
                                            <td class="custom-table-td"><?=$mainData[$i]["ConsigneeEmailId"]?></td>
                                            <td class="custom-table-td"><?=$mainData[$i]["ConsigneeAddress"]?></td>
                                            <td class="custom-table-td-img"><img src="<?=base_url('/resources/images/'.$mainData[$i]["ConsigneeImage"])?>" style="height:100px; width:100px;"></td>
                                            <td class="custom-table-td"><?=$mainData[$i]["ConsigneePhoneNo"]?></td>
                                            <td class="custom-table-td"><?=$mainData[$i]["ConsigneeGSTNO"]?></td>
                                            <td class="custom-table-td"><?=$mainData[$i]["ConsigneePANNo"]?></td>
                                            <td class="custom-table-td"><a id="<?=$mainData[$i]["ConsigneeId"]?>" class="updatedata" data-toggle="modal" data-target="#insert-modal" >
                                                <i class="fa fa-edit admin-custom-color-opp" ></i></a>
                                            <a id="<?=$mainData[$i]["ConsigneeId"]?>" class="deletedata"><i class="fa fa-trash admin-custom-color-opp" ></i></a>
                                            </td>                                            
                                        </tr> 
                                   <?php 
                                }
